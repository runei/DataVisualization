...
set(_vtk_installed_prefix "C:/vtk/vs12/lib/cmake/vtk-8.1")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "C:/vtk/vs12")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "C:/vtk/vs12/bin")
  else ()
    set (VTK_RUNTIME_DIRS "C:/vtk/vs12/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "C:/vtk-build-VS12/bin")
  else ()
    set (VTK_RUNTIME_DIRS "C:/vtk-build-VS12/lib")
  endif ()
endif()
