...
set(_vtk_installed_prefix "C:/vtk/vs15/lib/cmake/vtk-8.1")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "C:/vtk/vs15")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "C:/vtk/vs15/bin")
  else ()
    set (VTK_RUNTIME_DIRS "C:/vtk/vs15/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "C:/vtk-build-VS15/bin")
  else ()
    set (VTK_RUNTIME_DIRS "C:/vtk-build-VS15/lib")
  endif ()
endif()
